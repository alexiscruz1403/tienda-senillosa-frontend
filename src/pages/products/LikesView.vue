<template>
  <app-layout>
    <div class="h-screen w-full bg-[#F4F6FB] flex flex-col items-center">
      ...
      <div v-else class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 w-full py-8 px-4">
...
const fetchLikedProducts = async () => {
  loading.value = true;
  try {
    const response = await getData<PublicProduct[]>('/user/likes');
