  ...
  <app-layout>
    <div class="bg-[#F4F6FB] min-h-screen">
      ...
      <div class="px-4 py-8 flex flex-col lg:flex-row lg:items-start gap-4">
        ...
        <div class="flex flex-col gap-2 lg:hidden">
          ...
          <div class="flex gap-2">
            <button
              class="flex items-center gap-3 px-4 py-2 border border-[#ABABAB]! rounded-md"
        ...
        <div class="w-[25%] hidden lg:block shrink-0">
          <div class="sticky top-24 flex flex-col">
            ...
            <v-btn color="primary" @click="clearFilters" v-if="activeFilters()"
      ...
      <v-slide-x-transition>
        <div
          class="h-screen w-screen bg-black/60 fixed top-0 left-0 z-50"
          v-show="displayFilterSidebar"
        >
